...
public class ConnectionInfo {
  ...
  /**
   * 
   * @return If queried while connected to a CDB, returns the current container ID. Otherwise, returns 0.
   */
  ...
  /**
   * 
   * @return If queried while connected to a CDB, returns the current container name. Otherwise, returns the name of the database as specified in the DB_NAME initialization parameter.
   */  
   ...
   * @param currency The NLS currency
   * @throws SQLException Any SQL error during this operation
   */
